...
//  SpeedMath
//
//  Created by Connie Waffles on 27/03/2020.
...
struct Question {
    ...
    init() {
        let left = Int.random(in: 1...20)
        let right = Int.random(in: 1...20)
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .background(LinearGradient(gradient: Gradient(colors: [.pink, .blue]), startPoint: .topLeading, endPoint: .bottomTrailing))
